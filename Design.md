...
We place all special HDF5 data objects used by the VOL in a special group under the root group called the LOG group.
The LOG group, as well as all objects within it, is hidden from the user application.
