...
int main (int argc, char **argv) {
    ...
    hid_t file_id, group_id, datasetId, dataspaceId, file_space, memspace_id, attid_f, attid_d,
        attid_g;
    ...
    datasetId   = H5Dcreate (group_id, dataset_name, H5T_NATIVE_INT, dataspaceId, H5P_DEFAULT,
                           H5P_DEFAULT, H5P_DEFAULT);
    memspace_id = H5Screate_simple (1, dims + 1, NULL);
    file_space  = H5Dget_space (datasetId);
    attid_d =
        H5Acreate (datasetId, "Dataset_Att", H5T_NATIVE_INT, memspace_id, H5P_DEFAULT, H5P_DEFAULT);
    attid_f =
        H5Acreate (file_id, "File_Att", H5T_NATIVE_INT, memspace_id, H5P_DEFAULT, H5P_DEFAULT);
    attid_g =
        H5Acreate (group_id, "Group_Att", H5T_NATIVE_INT, memspace_id, H5P_DEFAULT, H5P_DEFAULT);
