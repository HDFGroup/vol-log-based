...
#define TIMER_FILE_SPECIFIC (TIMER_FILE_OPEN + 1)
#define TIMER_FILE_OPTIONAL (TIMER_FILE_OPEN + 1)
#define TIMER_FILE_CLOSE (TIMER_FILE_OPEN + 1)
#define TIMER_GROUP_CREATE 0
#define TIMER_GROUP_OPEN (TIMER_GROUP_CREATE + 1)
#define TIMER_GROUP_GET (TIMER_GROUP_OPEN + 1)
#define TIMER_GROUP_SPECIFIC (TIMER_GROUP_OPEN + 1)
#define TIMER_GROUP_OPTIONAL (TIMER_GROUP_OPEN + 1)
#define TIMER_GROUP_CLOSE (TIMER_GROUP_OPEN + 1)
