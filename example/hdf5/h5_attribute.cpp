...
int main(void)
{
    ...
    * Create a file.
    */
    file = H5Fcreate(H5FILE_NAME, H5F_ACC_TRUNC, H5P_DEFAULT, faplid);
    assert(file >= 0);
    ...
    * Reopen the file.
    */
    file = H5Fopen(H5FILE_NAME, H5F_ACC_RDONLY, faplid);
    assert(file >= 0);
    ...
    */
    //ret = H5Aiterate2(dataset, H5_INDEX_NAME, H5_ITER_INC, NULL, attr_info, NULL); assert(file >= 0);
